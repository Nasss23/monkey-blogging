        ...
        <label
            ...
            {image && (
                <Fragment>
                    ...
                    <button
                        type='button'
                        className='absolute z-10 flex items-center justify-center invisible w-16 h-16 text-red-600 transition-all bg-white rounded-full cursor-pointer group-hover:opacity-100 group-hover:visible'
            ...
            {!image && (
                <div
                    className='absolute bottom-0 left-0 h-1 transition-all bg-green-400 image-upload-progress'
                    style={{
